...
# if ((args.query is not None or args.zone is not None or args.metric is not None) and
#         (args.query is None or args.zone is None or args.metric is None)):
#     parser.error('The --query (-q), --zone (-z) and --metric (-m) options should be used togheter')
...
if (args.domains and
    ...
    parser.error(
        'The --domain (-d) options cannot be used with any other argument.')
